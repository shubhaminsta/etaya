...
import ResolutionMbl from "./ResolutionMbl";
...
const Resolution = () => {
  ...
  return (
    <section
      ...
      className="  relative xl:flex w-full  bg-gradient-to-b from-[#F9F6F0] to-[#F5A08A] overflow-hidden"
    >
      <div className="hidden xl:flex justify-center items-center  w-full max-w-[1440px]">
