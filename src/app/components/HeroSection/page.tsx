...
const Page = () => {
  ...
  const pathLength = useTransform(scrollYProgress, [0, 0.4], [0, 1]); // Animate path between 10% and 40% scroll
  ...
  return (
    <motion.div
      ref={ref}
      // style={{ y }}
      className="flex justify-center w-full max-w-[1440px] min-h-[100vh] pt-[150px] items-start bg-green-400 relative"
    >
      {/* Text content */}
      ...
      <div>
        ...
        {/* Animated SVG */}
        <motion.div
          className="absolute right-[11%] top-[380px]"
