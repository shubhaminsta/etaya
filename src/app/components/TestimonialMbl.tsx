...
export default function Testimonials() {
  ...
  return (
    ...
    >
      ...
      {/* Desktop View */}
      {/* <div className="hidden xl:grid w-full max-w-[1440px] mx-auto pl-[220px] pr-[120px] grid-cols-3 relative">
        <div className="w-full mt-[70px] mb-[120px] relative col-span-2">
          <motion.div className="w-[600px] mb-8">
            <motion.h2
              className="font-[Francois_One] text-[72px] leading-[80px] text-left text-[#DD4D2B] font-normal"
              style={{
                opacity: headingOpacity,
                y: headingY,
                scale: headingScale,
            ...
            <motion.p
              className="font-[Open_Sans] text-[16px] leading-[24px] tracking-[0.5px] text-white"
              style={{ opacity: paragraphOpacity, y: paragraphY }}
              transition={{ duration: 0.5 }}
            >
