...
const ResolutionMbl = () => {
  ...
  const circleOpacity2 = useTransform(scrollYProgress, [0.4, 0.6], [0, 1]);
  const circleOpacity3 = useTransform(scrollYProgress, [0.6, 0.8], [0, 1]);
      ...
      <div className="relative">
        <div className="relative w-full h-[667px] overflow-hidden">
          ...
          >
            ...
            <path
              d="M168.659 353.488C205.206 346.42 240.842 347.257 275.601 355.984C275.121 368.38 281.391 380.1 292.062 386.424C316.759 401.057 337.178 427.557 349.102 452.05C350.044 454.302 350.916 456.582 351.753 458.878C377.083 529.589 341.319 608.712 269.321 635.452C202.882 660.154 127.195 629.738 96.4376 565.927C77.888 527.433 78.702 485.093 94.5638 449.354C105.647 424.336 124.191 402.521 148.618 387.545C160.572 380.228 168.14 367.47 168.659 353.488Z"
              fill="url(#paint0_radial_1_3)"
            />
            <path
              d="M168.664 353.502C205.211 346.434 240.847 347.271 275.7 355.998C275.123 368.395 281.396 380.114 292.068 386.438C316.761 401.072 337.18 423.572 349.104 452.066C350.046 454.317 350.922 456.596 351.758 458.892C377.085 529.605 341.324 608.726 269.326 635.465C202.888 660.168 127.2 629.752 96.443 565.941C77.89 527.448 78.704 485.109 94.5693 449.368C105.652 424.35 124.197 402.535 148.624 387.559C160.578 380.242 168.145 367.484 168.664 353.502Z"
              stroke="#DD4D2B"
              strokeWidth="2"
              strokeMiterlimit="10"
            />
        ...
        {/* Paragraph */}
        <p className="font-[400] text-[14px] leading-[20px] tracking-[0.25px] font-[Open_Sans] text-black">
