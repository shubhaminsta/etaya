...
export default function Blogs() {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-[#DD4D2B] relative flex flex-col py-16 px-4 w-full max-w-[1440px] "
    >
      <div className="flex flex-col md:flex-row items-center">
        <div className="max-w-6xl  absolute top-[230px] left-[200px] mx-auto text-left">
          {/* Animated Heading */}
          <motion.h2
        ...
        <motion.svg
          ...
          className="absolute top-0 right-[380px]"
        >
          <motion.path
