...
import TestimonialMbl from "./TestimonialMbl";
...
export default function Testimonials() {
  ...
  const svgOpacity = useTransform(scrollYProgress, [0, 0.4], [0, 1]);
  ...
  return (
    ...
    >
      <div className="hidden xl:grid w-full max-w-[1440px] pl-[220px] pr-[120px] grid-cols-3 relative">
        <div className="w-full mt-[70px] mb-[120px] relative col-span-2">
          {/* Heading with Scroll-Based Animation */}
          <motion.div className="w-[600px] mb-8">
            <motion.h2
              className="font-[400] text-[72px] leading-[80px] text-left font-[Francois_One] text-[#DD4D2B]"
              style={{
            ...
            <motion.p
              className="font-[400] text-[16px] leading-[24px] tracking-[0.5px] font-[Open_Sans] text-white"
          ...
          <div className="flex flex-wrap gap-8 max-w-3xl mx-auto relative">
            {testimonials.map((t, index) => (
              ...
              >
                ...
                <div className="bg-white text-black relative h-[300px] w-[240px] rounded-lg p-6 shadow-lg flex flex-col items-center text-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            className="absolute top-[50px] right-[55px]"
          >
        ...
        <div className="flex relative flex-col w-full justify-start items-center">
          <svg
            ref={svgRef}
            width="403"
            height="656"
