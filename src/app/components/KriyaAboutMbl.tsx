...
const KriyaAboutMbl = () => {
  ...
  return (
    ...
    >
      ...
      "
        >
          <div className=" text-black px-[18px]">
            {/* Basic Information */}
            ...
            <section className="flex  flex-wrap justify-center gap-10 py-12">
        ...
        <div className="w-[376px]  mx-auto  h-[250px] flex justify-center items-center">
